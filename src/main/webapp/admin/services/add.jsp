    ...
    <%@ include file="/admin/common/util.jspf" %>
      <% Object sessionUser=session.getAttribute("userInfo"); if (!(sessionUser instanceof ict.bean.User) ||
        ...
        <head>
          ...
          <title>CCHC Admin - Add Service</title>
        ...
        <body>
          <%@ include file="/admin/common/nav.jspf" %>
              ...
              <section class="form-wrap">
                <div class="form-card">
                  <div class="form-intro">
                    <h1>Add Service</h1>
                    <p>Create a new medical service in the system catalog.</p>
                  </div>

                  <%@ include file="/admin/common/service-tabs.jspf" %>

                  <form class="form-grid" action="<%= request.getContextPath() %>/admin/services/add" method="post">
            ...
            <footer class="site-footer">
              <div class="container">Add service sample page.</div>
            </footer>
        </body>
